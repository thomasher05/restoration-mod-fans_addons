...
function ModifierDozerMedic:init(data)
	...
	local vanilla_medic_tank = Idstring("units/pd2_dlc_drm/characters/ene_bulldozer_medic/ene_bulldozer_medic")

	table.insert(unit_types.america, vanilla_medic_tank)
	table.insert(unit_types.russia, Idstring("units/pd2_mod_reapers/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
	table.insert(unit_types.zombie, vanilla_medic_tank)
	...
	table.insert(unit_types.nypd, vanilla_medic_tank)
	table.insert(unit_types.lapd, vanilla_medic_tank)
	table.insert(unit_types.fbi, vanilla_medic_tank)
	
	table.insert(unit_types_black.america, vanilla_medic_tank)
	table.insert(unit_types_black.russia, Idstring("units/pd2_mod_reapers/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
	table.insert(unit_types_black.zombie, vanilla_medic_tank)
	...
	table.insert(unit_types_black.murkywater, Idstring("units/pd2_dlc_bph/characters/ene_murkywater_bulldozer_medic/ene_murkywater_bulldozer_medic"))
	table.insert(unit_types_black.nypd, vanilla_medic_tank)
	table.insert(unit_types_black.lapd, vanilla_medic_tank)
	table.insert(unit_types_black.fbi, vanilla_medic_tank)

	table.insert(unit_types_skull.america, vanilla_medic_tank)
	table.insert(unit_types_skull.russia, Idstring("units/pd2_mod_reapers/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
	table.insert(unit_types_skull.zombie, vanilla_medic_tank)
	...
	table.insert(unit_types_skull.murkywater, Idstring("units/pd2_dlc_bph/characters/ene_murkywater_bulldozer_medic/ene_murkywater_bulldozer_medic"))
	table.insert(unit_types_skull.nypd, vanilla_medic_tank)
	table.insert(unit_types_skull.lapd, vanilla_medic_tank)
	table.insert(unit_types_skull.fbi, vanilla_medic_tank)

	if difficulty_index <= 7 then 
		table.insert(unit_types.america, classic_medic_unit_name)
		table.insert(unit_types.russia, Idstring("units/pd2_mod_reapers/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
		table.insert(unit_types.zombie, classic_medic_unit_name)
		table.insert(unit_types.federales, Idstring("units/pd2_dlc_bex/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
		...
		table.insert(unit_types_black.federales, Idstring("units/pd2_dlc_bex/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
		...
		table.insert(unit_types_skull.federales, Idstring("units/pd2_dlc_bex/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
