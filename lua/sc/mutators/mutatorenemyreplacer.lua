...
function MutatorEnemyReplacer:_get_unit_group_tank(difficulty_index)
	if not self._groups.tank then
		...
		--Introduce Titandozers, Benellidozers, and Minigundozers from now on. Sorry russia and zombie.
		...
		--DS introduces all types of dozers (including Medicdozers and both flamethrowers)
			self._groups.tank = {
				special_type = "tank",
				unit_types = {
					america = {
